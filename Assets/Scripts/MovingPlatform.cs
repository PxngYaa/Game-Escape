...
public class MovingPlatform : MonoBehaviour
{
    ...
    private void Awake(){
        ...
        wayPoints = new Transform[mays.transform.childCount];
        for (int i = 0; i < mays.gameObject.transform.childCount; i++){
            wayPoints[i] = mays.transform.GetChild(i).gameObject.transform;
        }
    }
